...
public class NowPlayingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvMovies = v.findViewById(R.id.rv_list_now);
        listMovies = new ArrayList<>();


        Call<ResponseMovies> call = UtilsApi.getAPIService().getNowPlaying(BuildConfig.MOVIE_DB_API, language, sort_by, include_adult, include_video, page);
        ...
        mRecyclerView = v.findViewById(R.id.rv_list_now);
